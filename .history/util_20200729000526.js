...
function validateCNPJ(str) {
    ...
    if ( (str == "00000000000000") || (str == "11111111111111") || (str == "22222222222222") || (str == "33333333333333") || 
         (str == "44444444444444") || (str == "55555555555555") || (str == "66666666666666") || (str == "77777777777777") || 
         (str == "88888888888888") || (str == "99999999999999") ) return false;

    let width = str.length - 2
    let numbers = str.substring(0, width);
    let digts = str.substring(width);
    let sum = 0;
    let pos = width - 7;
