...
function validateCNPJ(strNPJ) {

    if ( (strNPJ == "00000000000000") || (strNPJ == "11111111111111") || (strNPJ == "22222222222222") || (strNPJ == "33333333333333") || 
         (strNPJ == "44444444444444") || (strNPJ == "55555555555555") || (strNPJ == "66666666666666") || (strNPJ == "77777777777777") || 
         (strNPJ == "88888888888888") || (strNPJ == "99999999999999") ) return false;

    let width = strNPJ.length - 2
    let numbers = strNPJ.substring(0, width);
    let digts = strNPJ.substring(width);
    let sum = 0;
    let pos = width - 7;
    ...
    width = width + 1;
    numbers = strNPJ.substring(0, width);
    sum = 0;
    pos = width - 7;
